...
SWIFT_MODULE_NAMESPACE_PUSH("DQWebKit")
@class WKWebViewConfiguration;
@class NSCoder;

SWIFT_CLASS("_TtC8DQWebKit9DQWebView")
@interface DQWebView : WKWebView
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)Dcoder OBJC_DESIGNATED_INITIALIZER;
@end

@class NSBundle;

SWIFT_CLASS("_TtC8DQWebKit19DQWebViewController")
@interface DQWebViewController : UIViewController
- (void)viewDidLoad;
...
@interface DQWebViewController (SWIFT_EXTENSION(DQWebKit)) <WKNavigationDelegate, WKUIDelegate>
